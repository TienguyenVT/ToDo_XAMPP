...
?>
    <!-- Nhắc nhở -->
    <button type="button" class="btn btn-info btn-sm ms-2" data-bs-toggle="collapse" data-bs-target="#reminder-<?php echo $task_id; ?>">Nhắc nhở</button>
                ...
                <?php foreach ($reminders as $rem): ?>
                    <li class="list-group-item py-1 d-flex justify-content-between align-items-center">
                        ...
                        <form action="index.php" method="POST" class="d-inline">
                            ...
                            <button type="submit" name="delete_reminder" class="btn btn-outline-danger btn-sm btn-xs">X</button>
                        </form>
                    </li>
                <?php endforeach; ?>
            </ul>
