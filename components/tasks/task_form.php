            ...
            <form action="index.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <select name="priority" id="priority" class="form-select">
                        <option value="low" <?php echo ($edit_task && $edit_task['priority'] == 'low') ? 'selected' : ''; ?>>Thấp</option>
                        <option value="medium" <?php echo (!$edit_task || ($edit_task && $edit_task['priority'] == 'medium')) ? 'selected' : ''; ?>>Trung bình</option>
                        <option value="high" <?php echo ($edit_task && $edit_task['priority'] == 'high') ? 'selected' : ''; ?>>Cao</option>
                    </select>
                </div>
                <div class="d-grid">
                    <?php if ($edit_task): ?>
